    ...
    return async (req, res, next) => {
        ...
        try {
            ...
            if (!permissions) {
                ...
                const rolePerms = userWithRoles.userrole.flatMap(ur => ur.role.rolepermission.map(rp => rp.permission.name));
            ...
            if (!hasPermission) {
                ...
                await createAuditLog(userId, "SECURITY", "UNAUTHORIZED_ACCESS_ATTEMPT", tenantId, {
