...
export class OtpService {
     ...
     */
    static async verifyOtp(userId, code, purpose, targetId, currentIp) {
        ...
        const isContextValid = entry.purpose === purpose &&
