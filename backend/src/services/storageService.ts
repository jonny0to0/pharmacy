...
class StorageService {
   ...
   */
  public getImageUrlObject(baseKey: string | null): ImageObject | null {
   ...
   */
  async uploadImage(file: Express.Multer.File, type: string): Promise<ImageObject> {
   ...
   */
  async uploadFile(file: Express.Multer.File, type: string): Promise<{ url: string; key: string }> {
