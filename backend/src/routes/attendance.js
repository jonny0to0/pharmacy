...
// Check-In
router.post("/check-in", authenticateToken, auditLog("ATTENDANCE_CHECK_IN", "ATTENDANCE"), async (req, res) => {
    try {
        const tenantId = req.user.tenantId;
        const userId = req.user.userId;
...
// Check-Out
router.post("/check-out", authenticateToken, auditLog("ATTENDANCE_CHECK_OUT", "ATTENDANCE"), async (req, res) => {
    try {
