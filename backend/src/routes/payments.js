...
router.post("/receive", authenticateToken, requirePermission("PAYMENTS.CREATE"), validate(paymentSchema), async (req, res) => {
    try {
        ...
        const payment = await prisma.$transaction(async (tx) => {
            ...
            if (customerId) {
                ...
                if (!cust || cust.tenantId !== tenantId)
...
router.post("/pay", authenticateToken, requirePermission("PAYMENTS.CREATE"), validate(paymentSchema), async (req, res) => {
    try {
