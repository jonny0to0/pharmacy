 ...
 */
router.get("/search-user", authorizePermission("view_audit_logs"), async (req, res) => {
    try {
 ...
 */
router.post("/force-logout", authorizePermission("impersonate_user", "FULL"), async (req, res) => {
    try {
 ...
 */
router.post("/reset-password", authorizePermission("impersonate_user", "FULL"), async (req, res) => {
    try {
 ...
 */
router.get("/user-logs/:userId", authorizePermission("view_audit_logs"), async (req, res) => {
    try {
