 ...
 */
router.post("/", authorizePermission("manage_subscriptions", "FULL"), async (req, res) => {
    try {
 ...
 */
router.patch("/:id/deactivate", authorizePermission("manage_subscriptions", "FULL"), async (req, res) => {
    try {
        const { id } = req.params;
