 ...
 */
router.get("/", authorizePermission("manage_subscriptions"), async (req, res) => {
    try {
 ...
 */
router.post("/:id/action", authorizePermission("manage_subscriptions", "FULL"), async (req, res) => {
    try {
        ...
        switch (action.toUpperCase()) {
            case 'ACTIVATE':
                ...
                break;
            case 'SUSPEND':
                targetStatus = subscription_status.SUSPENDED;
                break;
            case 'RESUME':
                targetStatus = subscription_status.ACTIVE;
                break; // Transitions usually move to ACTIVE
            case 'CANCEL':
 ...
 */
router.get("/:id", authorizePermission("manage_subscriptions"), async (req, res) => {
    try {
        const { id } = req.params;
