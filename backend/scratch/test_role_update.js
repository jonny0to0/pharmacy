...
async function main() {
    ...
    try {
        ...
        const response = await fetch('http://localhost:5000/api/v1/roles/2424a1a8-792c-4a72-9e84-1057fe60cd1d', {
            method: 'PUT',
            headers: {
        ...
        const restoreResponse = await fetch('http://localhost:5000/api/v1/roles/2424a1a8-792c-4a72-9e84-1057fe60cd1d', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
main();
//# sourceMappingURL=test_role_update.js.map